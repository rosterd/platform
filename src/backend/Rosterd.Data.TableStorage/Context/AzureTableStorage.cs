...
namespace Rosterd.Data.TableStorage.Context
{
    public class AzureTableStorage : IAzureTableStorage
    {
        ...
        /// <returns></returns>
        public async Task<IEnumerable<T>> AddBatchAsync<T>(string tableName, IEnumerable<ITableEntity> entities, BatchOperationOptions options = null)
